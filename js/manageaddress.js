$(function(){
			...
			if(data.result == 0){
				if(data.content.addrs==''){
					...
					str +='<div class="lianxiren"><p>收货人：'	
							...
							'</div><div class="bottom"><p class="delete iconfont">&#xe61f; 删除</p><p class="edit iconfont">&#xe631; 编辑</p></div></div>'
					}
					$('section').html(str);
	...
	$("section ").delegate(".edit","click",function(){
		var address_id = $(this).parents(".dizhi").attr("address_id");
		var contact = ($(this).parents(".dizhi").find(".lianxiren").children("p").text()).split("：")[1];
