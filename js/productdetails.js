		...
		success: function(data){
			...
			if(data.result == 0){
				...
				for	(var j=0;j<staron;j++){
					starstr +='<span><img src="../img/star-on.png"/></span>'
				}
				if(starhalf == 1){//判断有没有半颗星
					starstr +='<span><img src="../img/star-half.png"/></span>'
				}
				if(staroff >0){//判断有没有星
					for	(var j=0;j<staroff;j++){
						starstr +='<span><img src="../img/star-off.png"/></span>'
					}
				}
					...
					if(evaluates ==''){
						...
						for(var i =0;i<evaluates.length;i++){
							...
							str +='<div class="listdetails" evaluate_id="'
									...
									'" onerror="this.src='+errorheadimg+';"/><p class="name">'
						...
						str +=	'<p class="time">'
								...
								'</div><div class="share"><span class="iconfont">&#xe615;</span> 分享</div></div><div class="pic-vid">'
